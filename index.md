...
longitude: "10.71881"       # decimal longitude of the workshop venue (use https://www.latlong.net)
...
helper: ["Naomi Yabe Magnussen", "Elisa Pierfederici", "Sofie Gilbert"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["sofie.gilbert@ub.uio.no","espen.rosenquist@gmail.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.capentries.org/2023-05-30-uio # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
{% comment %}
Data Carpentry: R for the Social Sciences and Humanities
